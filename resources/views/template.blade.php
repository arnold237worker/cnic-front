...
<head>
    ...
    <!-- template styles -->
    <link rel="stylesheet" href="{{asset('assets/css/conult.css?v6')}}" />
                    ...
                    <div class="main-header-two__top-inner clearfix">
                        <div class="main-header-two__top-left">
                            <ul class="list-unstyled main-header-two__top-address">
                                ...
                                <li>
                                    ...
                                    <div class="text">
                                        <p><a href="https://wa.me/+237676423188" target="_blank">(+237) 676 42 31 88</a> - <a href="https://wa.me/+237693918018" target="_blank">(+237) 693 91 80 18</a></p>
                                    </div>
                                </li>
                            </ul>
                        </div>
                        <div class="main-header-two__top-right">
                            <div class="main-header-two__top-right-social">
                                ...
                                <a href="https://www.youtube.com/channel/UC-FwXrDxvr6gj8x6Kgu3Neg" target="_blanl"><i class="fab fa-youtube"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-xl-6 col-lg-6">
                            <div class="site-footer__top-right">
                                <div class="site-footer__top-widget-box">
                                    <div class="row">
                                        <div class="col-xl-5 col-lg-5 col-md-4 wow fadeInUp" data-wow-delay="100ms">
                                        ...
                                        <div class="col-xl-7 col-lg-7 col-md-4 wow fadeInUp" data-wow-delay="300ms">
